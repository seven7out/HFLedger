...
Please do not open a public issue for a suspected vulnerability or include live Ledger data in a report. Use the repository host's private security-advisory feature. If that feature is unavailable, contact a maintainer privately through the publishing account before sharing details.
...
Ledger is designed around these boundaries:
